...
***Answer: The variablility differ from volume vs whole weight and shuck (meat) vs whole weight tend to have differences as we move farther along the x axis on the two graphs. In the first graph, there tends   ***
